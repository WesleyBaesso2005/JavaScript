...
let valor01 = 100;
const valor02 = 5;
console.log('A multiplicação ' + valor01 +' por ' + valor02 + ' é ' + valor01 * valor02 );

console.log(`A multiplicação de ${valor01} por ${valor02} é ${valor01 * valor02}`);

// Métodos de strings
console.clear();
const string01 = 'Instituto da Opurtunidade Social';
...
// Também vale espaços e caracteres especiais
